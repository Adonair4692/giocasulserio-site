...
window.GSS.ui = {
  it: {
    ...
    institutional: 'Scientifici e istituzionali', independent: 'Produzioni indipendenti', publications: 'Ricerca e divulgazione scientifica',
    projectsIntro: 'Esplora la libreria per console, proprietà e stato.', servicesClaim: 'Progettare. Testare. Valutare.',
    collaborations: 'Collaborazioni e network', archiveNumbers: 'Numeri della libreria', contactTitle: 'Mettiamo alla prova uno scenario.',
    contactText: 'Per progettazione, valutazione, tabletop exercise, conferenze e interventi.', write: 'Scrivi a info@giocasulserio.it',
    searchTitle: 'Cerca in tutto il sito', searchPlaceholder: 'Es. TTX, wargame, soft skills…', searchNoResults: 'Nessun risultato trovato.',
    ...
    scoreLabel: 'Black Swan Hunter Score', finish: 'Concludi l’esplorazione', reset: 'Azzera percorso', settings: 'Gestisci esperienza',
  ...
  en: {
    navHome: 'Home', navProjects: 'Cartridges', navResearch: 'Research & publications', navServices: 'Services', navAbout: 'About', navContacts: 'Contacts', navSearch: 'Search',
    start: 'Start exploring', selectSystem: 'Select a console', featured: 'Featured cartridges', allProjects: 'Open all cartridges',
    ...
    all: 'All', projects: 'Cartridges', services: 'Services', buyable: 'For sale', coming: 'Coming soon', open: 'Open',
    ...
    introText: 'Explore consoles, cartridges and publications. Meaningful interactions increase your Black Swan Score. Your journey stays on your device for seven days and requires no registration.',
    ...
    platinumText: 'You explored consoles, cartridges, publications and methods by following different paths. The hunt for black swans does not end here.',
    ...
    totalProjects: 'Cartridges', instProjects: 'Institutional', indieProjects: 'Independent', totalPubs: 'Publications', consolesCount: 'Consoles',
